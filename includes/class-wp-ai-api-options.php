...
class WP_AI_API_Options {
	...
	public function render_api_section_description() {
		echo '<p>' . esc_html__( 'Configure your API keys for the AI services you want to use in the WordPress AI Demo.', 'wp-ai-demo' ) . '</p>';
	}
			...
			<div class="notice notice-warning is-dismissible">
				<p>
					...
					printf(
						...
						esc_html__( 'WordPress AI Demo: No API key configured. The AI chat interface will not work. Please configure your OpenAI API key in the %s.', 'wp-ai-demo' ),
